...
export default function Login() {
    ...
    return (<div className="min-h-screen w-full flex items-center justify-center bg-zinc-950 text-zinc-100 relative overflow-hidden px-4 selection:bg-blue-500/30">
        ...
        <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
            <div className="glass rounded-[2rem] border border-white/10 p-10 shadow-2xl overflow-hidden relative">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-zinc-400 text-center">Enter your details to access your secure storage.</p>
                </div>
                ...
                <form onSubmit={handelLoginSubmit}
                    ...
                    {
                    errorMessage && (<div className="p-4 bg-red-500/10 border border-red-500/20 rounded-2xl text-red-400 text-sm animate-in shake duration-300"> {errorMessage} </div>)
                }
